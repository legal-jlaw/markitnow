          ...
          {step === 6 && (
            <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
              ...
              {[
                ...
                { num: 5, title: `Select '${form.basis === "use" ? "Use in Commerce — Section 1(a)" : "Intent to Use — Section 1(b)}'`, body: form.basis === "use" ? "You'll be asked to provide your first use date and first use in commerce date. Enter the date you first used the mark to sell goods/services." : "Select Intent to Use. You won't need a specimen now. You'll file a Statement of Use later after you launch." },
