...
const FAQS = [
  ...
  },
  {
    ...
    questions: [
      ...
      { q: "How long does it take to register a trademark?", a: "The USPTO trademark registration timeline typically runs 13–18 months for a straightforward application: 1–3 days for filing receipt and serial number; 3–4 months for examiner assignment and review; 4–6 months for initial approval or Office Action; approximately 12 months for publication in the Official Gazette; 30-day opposition period; and approximately 13–18 months total for certificate of registration. Complex applications with Office Actions or oppositions can take significantly longer." },
    ],
  },
  {
  ...
  },
  {
    ...
    questions: [
      ...
      { q: "What is a Section 8 Declaration and Section 15 Declaration?", a: "A Section 8 Declaration is a sworn statement filed between years 5–6 of registration confirming the mark is still in active commercial use. Failure to file cancels the registration. A Section 15 Declaration of Incontestability, filed concurrently with Section 8, makes your trademark registration immune to most legal challenges after 5 years of continuous use. Combined, they significantly strengthen your trademark rights. The USPTO fee for Section 8 is $225/class and Section 15 is $250/class. Our fee for both is $199." },
        ...
        <nav style={{ background: "#fff", borderBottom: "1px solid #e0e0e0", display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 48px", height: 64 }}>
          ...
          <div style={{ display: "flex", gap: 32, alignItems: "center" }}>
            {["How It Works", "Pricing", "FAQ"].map(item => (
              <span key={item} onClick={() => item === "Pricing" ? router.push("/pricing") : item === "How It Works" ? router.push("/how-it-works") : item === "FAQ" ? router.push("/faq") : null}
                style={{ color: item === "FAQ" ? "#c9a84c" : "#555", fontSize: 14, fontWeight: item === "FAQ" ? 700 : 500, cursor: "pointer" }}>{item}</span>
            ))}
