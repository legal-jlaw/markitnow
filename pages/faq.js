...
const FAQS = [
  ...
  },
  {
    ...
    questions: [
      { q: "How do I file a trademark application with the USPTO?", a: "Trademark applications are filed through the USPTO's TEAS (Trademark Electronic Application System) at teas.uspto.gov. You'll need: your mark (word or design), the owner's legal name and address, the goods and services you want to cover, the Nice classification class(es), a filing basis (use in commerce or intent to use), and payment of the USPTO filing fee ($350 per class). MarkItNow offers three paths: free DIY guidance, AI-assisted DIY filing ($199), or full attorney-filed application ($399 + USPTO fees)." },
      { q: "What is TEAS Plus vs TEAS Standard?", a: "TEAS Plus and TEAS Standard are both USPTO online filing options at $350 per class (as of 2026). The key difference is that TEAS Plus requires you to use pre-approved identification language from the USPTO ID Manual for your goods and services description. Using custom or free-form identification language triggers a $200/class surcharge. Our AI automatically drafts USPTO ID Manual-compliant descriptions to avoid this surcharge." },
  ...
  {
    category: "Our Reports and Analysis",
    questions: [
      { q: "What does the AI Analysis Report actually analyze?", a: "Most trademark search tools only check for exact matches. The MarkItNow AI Analysis Report runs multiple searches including exact match, phonetic variations, and similar marks in your class. It then scores each conflict against the DuPont factors that courts and USPTO examiners use to determine likelihood of confusion. You receive a risk score, a breakdown of your highest-risk conflicts, and a plain-language explanation of why each one matters. The report is delivered as a PDF instantly after purchase for $99 with no account required." },
      { q: "How is the AI Analysis Report different from a free trademark search?", a: "A free trademark search returns a list of results. The AI Analysis Report interprets those results using legal standards. It identifies which conflicts are likely to cause a USPTO refusal, which are low risk, and why. It applies the 13 DuPont factors to your specific mark and the conflicting marks found, giving you actionable intelligence before you spend $350 per class on a USPTO filing fee." },
      { q: "What is the AI Legal Memo and who needs it?", a: "The AI Legal Memo is a $149 structured legal analysis formatted as a professional memo. It covers registrability, likelihood of confusion, descriptiveness, and filing strategy. It is useful for founders presenting to investors, business owners who want a written record of their trademark clearance process, or anyone who needs more depth than the AI Analysis Report provides. It is AI-generated and clearly labeled as such. It is not a substitute for legal advice from a licensed attorney." },
      { q: "Is the AI Analysis Report a substitute for hiring a trademark attorney?", a: "No. The AI Analysis Report is an informational tool designed to help you understand your risk before you file. It does not constitute legal advice and does not create an attorney-client relationship. For complex situations including marks with multiple conflicts, descriptiveness issues, or non-traditional marks, we recommend our attorney-filed application service or a direct consultation with a licensed trademark attorney." },
    ],
  },
  {
    category: "Costs & Pricing",
    questions: [
      { q: "How much does it cost to trademark a name or logo?", a: "The total cost to trademark a name or logo includes our service fee plus USPTO government fees. Attorney-filed application: $399 (our fee) + $350/class (USPTO) = $749+ per class. DIY guided filing: $199 (our fee) + $350/class (USPTO) = $419+ per class. For a smooth single-class registration with no issues, budget $750 to $1,100 total including potential Statement of Use fees. Multi-class applications multiply the USPTO fee by the number of classes. We always show you the exact total before you pay." },
      { q: "What are USPTO trademark filing fees in 2026?", a: "As of 2026, USPTO trademark filing fees are: TEAS application (Sections 1 & 44): $350/class. Custom identification surcharge: $200/class extra. Statement of Use / Amendment to Allege Use: $150/class. Extension of time to file Statement of Use: $125/class per extension. Section 8 Declaration: $225/class. Section 15 Declaration: $250/class. Section 9 Renewal: $325/class. Petition to Revive: $150. These are government fees paid directly to the USPTO, separate from any attorney or service fees." },
...
export default function FAQ() {
  ...
  return (
    <>
      <Head>
        <title>Trademark FAQ: How to Register, Search, File and Protect Your Brand | MarkItNow.ai</title>
        <meta name="description" content="Answers to the most common trademark questions: USPTO filing fees, likelihood of confusion, DuPont factors, Office Actions, TEAS Plus, trademark renewals, AI analysis reports, and more. Free trademark search at MarkItNow.ai." />
